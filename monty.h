...
void f_pushV2(stack_tV2 **head, unsigned int number);
void f_pallV2(stack_tV2 **head, unsigned int number);
void f_pintV2(stack_tV2 **head, unsigned int number);
int execute(char *contentV2, stack_tV2 **head, unsigned int counterV2, FILE *file);
void free_stackV2(stack_tV2 *head);
void f_popV2(stack_tV2 **head, unsigned int counterV2);
void f_swapV2(stack_tV2 **head, unsigned int counterV2);
void f_addV2(stack_tV2 **head, unsigned int counterV2);
void f_nopV2(stack_tV2 **head, unsigned int counterV2);
void f_subV2(stack_tV2 **head, unsigned int counterV2);
void f_divV2(stack_tV2 **head, unsigned int counterV2);
void f_mulV2(stack_tV2 **head, unsigned int counterV2);
void f_modV2(stack_tV2 **head, unsigned int counterV2);
void f_pcharV2(stack_tV2 **head, unsigned int counterV2);
void f_pstrV2(stack_tV2 **head, unsigned int counterV2);
void f_rotlV2(stack_tV2 **head, unsigned int counterV2);
...
void f_stackV2(stack_tV2 **head, unsigned int counterV2);
#endif
